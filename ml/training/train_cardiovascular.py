...
def train_cardiovascular_model() -> None:
    master = load_dataset()

    cardiovascular_df = master.dropna(
        subset=["cardiovascular"]
    )

    X = cardiovascular_df[FEATURES]
    y = cardiovascular_df["cardiovascular"]
    ...
    # joblib.dump(
    # model,
    # filename=MODEL_DIR / "cardiovascular_model.pkl",
    # )
    #
    # logger.info(
    #     "Model saved to %s",
    #     MODEL_DIR / "cardiovascular_model.pkl",
    # )
